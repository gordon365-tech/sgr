...
async def test_pipeline():
    ...
    try:
        ...
        from sgr.core.types import (
            ExchangeID, MarketRegime, OrderStatus, PositionSide,
            RiskDecision, Signal, SignalDirection, Symbol, TradingMode,
            TradingCycleStatus
        )
        ...
        print(f"✓ Portfolio engine initialized with $10,000 USDT")
        ...
        print(f"✓ Market data loaded: BTC/USDT @ $50,500")
